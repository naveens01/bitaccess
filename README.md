...
| 4    | Deployment   |            | <ol><li>portalbundle-deploy</li><li>esexp-deploy</li></ol>                   | <ol><li>If the installation type is "bundle" and either the tier is not "paid" with global replicas not equal to 0, or the deployment type is "basic" and the tier is "paid"</
